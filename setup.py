import setuptools
from stroke_maps import __version__
...
setuptools.setup(
    ...
    description="Stroke modelling: package for maps of stroke units and LSOAs.",
    # read in above from readme.md and will appear on PyPi
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/stroke-modelling/stroke-maps",
